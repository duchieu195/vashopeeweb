  ...
  return (
    <header className="bg-primary sticky top-0 z-40 shadow-md">
      ...
      <div className="bg-primary-dark">
        <div className="max-w-7xl mx-auto px-4 flex gap-6 text-sm text-white/90 py-1.5">
          <Link to="/" className="hover:text-white transition-colors">Trang Chủ</Link>
          <Link to="/products" className="hover:text-white transition-colors">Tất Cả Sản Phẩm</Link>
          {categories.map((cat) => (
            <Link
              key={cat.id}
